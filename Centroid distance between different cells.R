...
cell_types <- c("NecrosisRate<90%(TC1)_PT15",
                "NecrosisRate<90%(TC1) PT16",
                "NecrosisRate<90%(TC1) PT12",
                "NecrosisRate<90%(TC1)_PT09",
                "NecrosisRate<90%(TC1) PT11",
                "C1_Endothelial cells",
                "C2_Endothelial cells",
                "C3_Endothelial cells",
                "C4_Endothelial cells",
                "C5_Endothelial cells")
