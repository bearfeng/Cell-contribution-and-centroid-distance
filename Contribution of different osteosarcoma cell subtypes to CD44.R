...
# Read  different CARD objects,the code demonstrates the data loading for PT09, and the code for PT11, PT12, PT15, and PT16 follows the same pattern.
...
min_max_scores$CompositeScore <- min_max_scores$CD44
